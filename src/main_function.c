                      ...
                      struct cellule_compagnieDATA *HT_comp_data[max_Hdatacomp])
{
    ...
    */
    ...
    {
    case 0:
        init_avg_flight_duration (liste, HT_main);
        break;
    case 1:
        init_changed_flights (liste, HT_main);
        break;
    case 2:
        init_delayed_airlines (liste, HT_main);
        break;
    case 3:
        init_find_itinerary (liste, HT_main);
        break;
    ...
    case 8:
        ...
        break;
    case 9:
        init_show_airlines (liste, HT_main, HT_comp_data);
        break;
    case 10:
        init_show_airport (liste, HT_main);
        break;
    case 11:
        init_show_flights (liste, HT_main);
        break;
    default:
